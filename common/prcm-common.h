/* ======================================================================= *//**
 * @Component			OMAPCONF
 * @Filename			prcm-common.h
 * @Description			OMAP2/3 PRCM base and module definitions
...
#define OMAP3430ES2_GFX_MOD				GFX_MOD
...
#define OMAP4430_CM1_DSP_MOD		0x0400
...
#define OMAP3430_EN_C2C					(1 << 3)
#define OMAP3430_EN_C2C_SHIFT				3
...
#define OMAP3430_ST_C2C_SHIFT				3
#define OMAP3430_ST_C2C_MASK				(1 << 3)
