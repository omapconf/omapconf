 ...
 *  @Component			OMAPCONF
 *  @Filename			cm44xx.h
 *  @Description		OMAP44xx CM1 & CM2 instance offset macros
 *//*======================================================================== */
/*
...
#define OMAP44XX_CM1_REGADDR(module, reg) (OMAP4430_CM1_BASE + (module) + (reg))
#define OMAP44XX_CM2_REGADDR(module, reg) (OMAP4430_CM2_BASE + (module) + (reg))
...
/* CM1.DSP_CM1 register offsets */
#define OMAP4430_CM_DSP_CLKSTCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_CM1_DSP_MOD, 0x0000)
#define OMAP4430_CM_DSP_STATICDEP			OMAP44XX_CM1_REGADDR(OMAP4430_CM1_DSP_MOD, 0x0004)
#define OMAP4430_CM_DSP_DYNAMICDEP			OMAP44XX_CM1_REGADDR(OMAP4430_CM1_DSP_MOD, 0x0008)
#define OMAP4430_CM_DSP_DSP_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_CM1_DSP_MOD, 0x0020)
...
#define OMAP4430_CM_CLKSEL_MPU_M3_ISS_ROOT		OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CKGEN_MOD, 0x0000)
...
#define OMAP4430_CM_IVA_DVFS_PERF_DSP			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CKGEN_MOD, 0x0028)
...
#define OMAP4430_CM_MPU_M3_CLKSTCTRL			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0200)
#define OMAP4430_CM_MPU_M3_STATICDEP			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0204)
#define OMAP4430_CM_MPU_M3_DYNAMICDEP			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0208)
#define OMAP4430_CM_MPU_M3_MPU_M3_CLKCTRL		OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0220)
...
#define OMAP4430_CM_C2C_CLKSTCTRL			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0500)
#define OMAP4430_CM_C2C_STATICDEP			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0504)
#define OMAP4430_CM_C2C_DYNAMICDEP			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0508)
#define OMAP4430_CM_C2C_C2C_CLKCTRL			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0520)
#define OMAP4430_CM_C2C_MODEM_ICR_CLKCTRL		OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0528)
#define OMAP4430_CM_C2C_C2C_FW_CLKCTRL		OMAP44XX_CM2_REGADDR(OMAP4430_CM2_CORE_MOD, 0x0530)
...
#define OMAP4430_CM_DSS_BB2D_CLKCTRL			OMAP44XX_CM2_REGADDR(OMAP4430_CM2_DSS_MOD, 0x0028)
