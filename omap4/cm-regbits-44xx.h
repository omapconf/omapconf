/* ======================================================================= *//**
 *  @Component			OMAPCONF
 *  @Filename			cm-regbits-44xx.h
 *  @Description		OMAP44xx Clock Management register bits
 *//*======================================================================== */
/*
...
/* Used by CM_L3_1_DYNAMICDEP, CM_MPU_DYNAMICDEP, CM_DSP_DYNAMICDEP */
#define OMAP4430_ABE_DYNDEP_SHIFT				3
#define OMAP4430_ABE_DYNDEP_MASK				BITFIELD(3, 3)

/*
 * Used by CM_C2C_STATICDEP, CM_MPU_M3_STATICDEP, CM_SDMA_STATICDEP,
...
/* Used by CM_MPU_M3_STATICDEP, CM_MPU_STATICDEP, CM_DSP_STATICDEP */
...
/* Used by CM_MPU_M3_CLKSTCTRL */
#define OMAP4430_CLKACTIVITY_MPU_M3_GCLK_SHIFT			8
#define OMAP4430_CLKACTIVITY_MPU_M3_GCLK_MASK			BITFIELD(8, 8)
...
#define OMAP4430_CLKACTIVITY_L3_C2C_GICLK_SHIFT			8
#define OMAP4430_CLKACTIVITY_L3_C2C_GICLK_MASK			BITFIELD(8, 8)
...
/* Used by CM_C2C_CLKSTCTRL */
#define OMAP4430_CLKACTIVITY_L4_C2C_GICLK_SHIFT			9
#define OMAP4430_CLKACTIVITY_L4_C2C_GICLK_MASK			BITFIELD(9, 9)
...
/* Used by CM_GFX_CLKSTCTRL */
#define OMAP4430_CLKACTIVITY_GFX_GFCLK_SHIFT			9
#define OMAP4430_CLKACTIVITY_GFX_GFCLK_MASK			BITFIELD(9, 9)
...
#define OMAP4430_CLKACTIVITY_DSP_ROOT_CLK_SHIFT		8
#define OMAP4430_CLKACTIVITY_DSP_ROOT_CLK_MASK		BITFIELD(8, 8)
 ...
 * CM_DPLL_SYS_REF_CLKSEL, CM_L4_WKUP_CLKSEL, CM_CLKSEL_MPU_M3_ISS_ROOT,
 * CM_CLKSEL_USB_60MHZ
 */
...
/* Used by CM_GFX_GFX_CLKCTRL */
#define OMAP4430_CLKSEL_GFX_FCLK_SHIFT				24
#define OMAP4430_CLKSEL_GFX_FCLK_MASK				BITFIELD(24, 24)
...
/*
 * Used by CM_WKUP_CLKSTCTRL, CM_EMU_CLKSTCTRL, CM_C2C_CLKSTCTRL,
 * CM_MPU_M3_CLKSTCTRL, CM_L3INSTR_CLKSTCTRL, CM_L3_1_CLKSTCTRL,
 ...
 * CM_IVAHD_CLKSTCTRL, CM_DSS_CLKSTCTRL, CM_MPU_CLKSTCTRL, CM_DSP_CLKSTCTRL,
...
#define OMAP4430_C2C_DYNDEP_SHIFT				18
#define OMAP4430_C2C_DYNDEP_MASK				BITFIELD(18, 18)

/* Used by CM_MPU_STATICDEP */
#define OMAP4430_C2C_STATDEP_SHIFT				18
#define OMAP4430_C2C_STATDEP_MASK				BITFIELD(18, 18)
...
/*
 * Used by CM_MPU_M3_STATICDEP, CM_SDMA_STATICDEP, CM_SDMA_STATICDEP_RESTORE,
 * CM_MPU_STATICDEP
 */
...
#define OMAP4430_MPU_M3_DYNDEP_SHIFT				0
#define OMAP4430_MPU_M3_DYNDEP_MASK				BITFIELD(0, 0)

/* Used by CM_SDMA_STATICDEP, CM_SDMA_STATICDEP_RESTORE, CM_MPU_STATICDEP */
#define OMAP4430_MPU_M3_STATDEP_SHIFT				0
#define OMAP4430_MPU_M3_STATDEP_MASK				BITFIELD(0, 0)
...
/* Used by CM_MPU_M3_STATICDEP, CM_MPU_STATICDEP */
 ...
 * CM_WKUP_WDT2_CLKCTRL, CM_EMU_DEBUGSS_CLKCTRL, CM_C2C_MODEM_ICR_CLKCTRL,
 * CM_C2C_C2C_CLKCTRL, CM_C2C_C2C_FW_CLKCTRL, CM_MPU_M3_MPU_M3_CLKCTRL,
 ...
 * CM_MPU_MPU_CLKCTRL, CM_DSP_DSP_CLKCTRL, CM1_ABE_AESS_CLKCTRL,
...
/*
 * Used by CM_C2C_STATICDEP, CM_MPU_M3_STATICDEP, CM_SDMA_STATICDEP,
 * CM_SDMA_STATICDEP_RESTORE, CM_MPU_STATICDEP, CM_DSP_STATICDEP
 */
 ...
 * CM_DSS_DYNAMICDEP, CM_MPU_DYNAMICDEP, CM_DSP_DYNAMICDEP
 */
...
/*
 * Used by CM_EMU_DYNAMICDEP, CM_C2C_DYNAMICDEP, CM_MPU_M3_DYNAMICDEP,
...
/*
 * Used by CM_MPU_M3_STATICDEP, CM_SDMA_STATICDEP, CM_L3INIT_STATICDEP,
...
/*
 * Used by CM_C2C_DYNAMICDEP, CM_L3_1_DYNAMICDEP, CM_L4CFG_DYNAMICDEP,
 * CM_MPU_DYNAMICDEP
 */
...
/*
 * Used by CM_EMU_DEBUGSS_CLKCTRL, CM_C2C_C2C_CLKCTRL,
 * CM_MPU_M3_MPU_M3_CLKCTRL, CM_SDMA_SDMA_CLKCTRL, CM_GFX_GFX_CLKCTRL,
...
/* Used by CM_L4CFG_DYNAMICDEP */
#define OMAP4430_DSP_DYNDEP_SHIFT				1
#define OMAP4430_DSP_DYNDEP_MASK				BITFIELD(1, 1)

/* Used by CM_MPU_M3_STATICDEP, CM_MPU_STATICDEP */
#define OMAP4430_DSP_STATDEP_SHIFT				1
#define OMAP4430_DSP_STATDEP_MASK				BITFIELD(1, 1)

/*
 * Used by CM_EMU_DYNAMICDEP, CM_C2C_DYNAMICDEP, CM_MPU_M3_DYNAMICDEP,
 * CM_L3_1_DYNAMICDEP, CM_L3_2_DYNAMICDEP, CM_L4CFG_DYNAMICDEP,
 * CM_L4PER_DYNAMICDEP, CM_MPU_DYNAMICDEP, CM_DSP_DYNAMICDEP
 */
