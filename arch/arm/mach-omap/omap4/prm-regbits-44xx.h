/* ======================================================================= *//**
 *  @Component			OMAPCONF
 *  @Filename			prm-regbits-44xx.h
 *  @Description		OMAP44xx Power Management register bits
 *//*======================================================================== */
/*
...
/* Used by PRM_IRQENABLE_MPU_M3, PRM_IRQENABLE_MPU */
#define OMAP4430_ABB_IVA_DONE_EN_SHIFT					31
#define OMAP4430_ABB_IVA_DONE_EN_MASK					BITFIELD(31, 31)

/* Used by PRM_IRQSTATUS_MPU_M3, PRM_IRQSTATUS_MPU */
...
/* Used by PRM_IRQENABLE_MPU_M3, PRM_IRQENABLE_MPU, PRM_IRQENABLE_DSP */
#define OMAP4430_DPLL_IVA_RECAL_EN_SHIFT				2
#define OMAP4430_DPLL_IVA_RECAL_EN_MASK					BITFIELD(2, 2)

/* Used by PRM_IRQSTATUS_MPU_M3, PRM_IRQSTATUS_MPU, PRM_IRQSTATUS_DSP */
...
/* Used by PM_CORE_PWRSTCTRL */
#define OMAP4430_MPU_M3_L2RAM_ONSTATE_SHIFT				20
#define OMAP4430_MPU_M3_L2RAM_ONSTATE_MASK				BITFIELD(20, 21)

/* Used by PM_CORE_PWRSTCTRL */
#define OMAP4430_MPU_M3_L2RAM_RETSTATE_SHIFT				10
#define OMAP4430_MPU_M3_L2RAM_RETSTATE_MASK				BITFIELD(10, 10)

/* Used by PM_CORE_PWRSTST */
#define OMAP4430_MPU_M3_L2RAM_STATEST_SHIFT				8
#define OMAP4430_MPU_M3_L2RAM_STATEST_MASK				BITFIELD(8, 9)

/* Used by PM_CORE_PWRSTCTRL */
#define OMAP4430_MPU_M3_UNICACHE_ONSTATE_SHIFT				22
#define OMAP4430_MPU_M3_UNICACHE_ONSTATE_MASK				BITFIELD(22, 23)

/* Used by PM_CORE_PWRSTCTRL */
#define OMAP4430_MPU_M3_UNICACHE_RETSTATE_SHIFT				11
#define OMAP4430_MPU_M3_UNICACHE_RETSTATE_MASK				BITFIELD(11, 11)

/* Used by PM_CORE_PWRSTST */
#define OMAP4430_MPU_M3_UNICACHE_STATEST_SHIFT				10
#define OMAP4430_MPU_M3_UNICACHE_STATEST_MASK				BITFIELD(10, 11)

/* Used by RM_MPU_RSTST */
#define OMAP4430_EMULATION_RST_SHIFT					0
#define OMAP4430_EMULATION_RST_MASK					BITFIELD(0, 0)

/* Used by RM_MPU_M3_RSTST */
...
/* Used by PRM_IRQENABLE_MPU_M3, PRM_IRQENABLE_DSP */
#define OMAP4430_FORCEWKUP_EN_SHIFT					10
#define OMAP4430_FORCEWKUP_EN_MASK					BITFIELD(10, 10)

/* Used by PRM_IRQSTATUS_MPU_M3, PRM_IRQSTATUS_DSP */
 ...
 * PM_DSS_PWRSTST, PM_L4PER_PWRSTST, PM_DSP_PWRSTST, PM_IVAHD_PWRSTST
 */
 ...
 * PM_MPU_PWRSTCTRL, PM_DSS_PWRSTCTRL, PM_L4PER_PWRSTCTRL, PM_DSP_PWRSTCTRL,
 * PM_IVAHD_PWRSTCTRL
 */
 ...
 * RM_EMU_DEBUGSS_CONTEXT, RM_C2C_C2C_CONTEXT, RM_C2C_C2C_FW_CONTEXT,
 * RM_MPU_M3_MPU_M3_CONTEXT, RM_L3INSTR_L3_3_CONTEXT,
 ...
 * RM_DSP_DSP_CONTEXT, RM_IVAHD_IVAHD_CONTEXT, RM_IVAHD_SL2_CONTEXT
 */
#define OMAP4430_LOSTCONTEXT_DFF_SHIFT					0
#define OMAP4430_LOSTCONTEXT_DFF_MASK					BITFIELD(0, 0)

/*
 * Used by RM_C2C_MODEM_ICR_CONTEXT, RM_C2C_C2C_CONTEXT,
 * RM_C2C_C2C_FW_CONTEXT, RM_MPU_M3_MPU_M3_CONTEXT, RM_L3INSTR_L3_3_CONTEXT,
 ...
 * RM_L4SEC_RNG_CONTEXT, RM_L4SEC_SHA2MD51_CONTEXT, RM_DSP_DSP_CONTEXT
 */
...
/*
 * Used by RM_C2C_MODEM_ICR_CONTEXT, RM_MEMIF_DMM_CONTEXT,
...
/* Used by RM_MPU_M3_MPU_M3_CONTEXT */
#define OMAP4430_LOSTMEM_MPU_M3_L2RAM_SHIFT				9
#define OMAP4430_LOSTMEM_MPU_M3_L2RAM_MASK				BITFIELD(9, 9)

/* Used by RM_MPU_M3_MPU_M3_CONTEXT */
#define OMAP4430_LOSTMEM_MPU_M3_UNICACHE_SHIFT				8
#define OMAP4430_LOSTMEM_MPU_M3_UNICACHE_MASK				BITFIELD(8, 8)
...
#define OMAP4430_LOSTMEM_DSP_EDMA_SHIFT					10
#define OMAP4430_LOSTMEM_DSP_EDMA_MASK					BITFIELD(10, 10)

/* Used by RM_DSP_DSP_CONTEXT */
#define OMAP4430_LOSTMEM_DSP_L1_SHIFT					8
#define OMAP4430_LOSTMEM_DSP_L1_MASK					BITFIELD(8, 8)

/* Used by RM_DSP_DSP_CONTEXT */
#define OMAP4430_LOSTMEM_DSP_L2_SHIFT					9
#define OMAP4430_LOSTMEM_DSP_L2_MASK					BITFIELD(9, 9)
 ...
 * PM_DSS_PWRSTCTRL, PM_L4PER_PWRSTCTRL, PM_DSP_PWRSTCTRL, PM_IVAHD_PWRSTCTRL
 */
 ...
 * PM_DSP_PWRSTCTRL, PM_IVAHD_PWRSTCTRL
 */
...
/* Used by RM_MPU_M3_RSTCTRL, RM_DSP_RSTCTRL, RM_IVAHD_RSTCTRL */
#define OMAP4430_RST1_SHIFT						0
#define OMAP4430_RST1_MASK						BITFIELD(0, 0)

/* Used by RM_MPU_M3_RSTST, RM_DSP_RSTST, RM_IVAHD_RSTST */
...
/* Used by RM_MPU_M3_RSTCTRL, RM_IVAHD_RSTCTRL */
#define OMAP4430_RST3_SHIFT						2
#define OMAP4430_RST3_MASK						BITFIELD(2, 2)

/* Used by RM_MPU_M3_RSTST, RM_IVAHD_RSTST */
...
#define OMAP4430_DSPSS_EMU_RSTST_SHIFT					2
#define OMAP4430_DSPSS_EMU_RSTST_MASK					BITFIELD(2, 2)

/* Used by RM_DSP_RSTST */
#define OMAP4430_DSP_DSP_EMU_REQ_RSTST_SHIFT				3
#define OMAP4430_DSP_DSP_EMU_REQ_RSTST_MASK				BITFIELD(3, 3)

/* Used by PM_DSP_PWRSTCTRL */
#define OMAP4430_DSP_EDMA_ONSTATE_SHIFT					20
#define OMAP4430_DSP_EDMA_ONSTATE_MASK					BITFIELD(20, 21)

/* Used by PM_DSP_PWRSTCTRL */
#define OMAP4430_DSP_EDMA_RETSTATE_SHIFT				10
#define OMAP4430_DSP_EDMA_RETSTATE_MASK					BITFIELD(10, 10)

/* Used by PM_DSP_PWRSTST */
#define OMAP4430_DSP_EDMA_STATEST_SHIFT					8
#define OMAP4430_DSP_EDMA_STATEST_MASK					BITFIELD(8, 9)

/* Used by PM_DSP_PWRSTCTRL */
#define OMAP4430_DSP_L1_ONSTATE_SHIFT					16
#define OMAP4430_DSP_L1_ONSTATE_MASK					BITFIELD(16, 17)

/* Used by PM_DSP_PWRSTCTRL */
#define OMAP4430_DSP_L1_RETSTATE_SHIFT					8
#define OMAP4430_DSP_L1_RETSTATE_MASK					BITFIELD(8, 8)

/* Used by PM_DSP_PWRSTST */
#define OMAP4430_DSP_L1_STATEST_SHIFT					4
#define OMAP4430_DSP_L1_STATEST_MASK					BITFIELD(4, 5)

/* Used by PM_DSP_PWRSTCTRL */
#define OMAP4430_DSP_L2_ONSTATE_SHIFT					18
#define OMAP4430_DSP_L2_ONSTATE_MASK					BITFIELD(18, 19)

/* Used by PM_DSP_PWRSTCTRL */
#define OMAP4430_DSP_L2_RETSTATE_SHIFT				9
#define OMAP4430_DSP_L2_RETSTATE_MASK					BITFIELD(9, 9)

/* Used by PM_DSP_PWRSTST */
#define OMAP4430_DSP_L2_STATEST_SHIFT					6
#define OMAP4430_DSP_L2_STATEST_MASK					BITFIELD(6, 7)
...
#define OMAP4430_WKUPDEP_DISPC_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_DISPC_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_DISPC_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_DISPC_DSP_MASK					BITFIELD(2, 2)
...
/* Used by PM_ABE_DMIC_WKDEP */
#define OMAP4430_WKUPDEP_DMIC_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_DMIC_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_ABE_DMIC_WKDEP */
#define OMAP4430_WKUPDEP_DMIC_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_DMIC_IRQ_DSP_MASK				BITFIELD(2, 2)
...
#define OMAP4430_WKUPDEP_DMTIMER11_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_DMTIMER11_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_DMTIMER3_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_DMTIMER3_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_DMTIMER4_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_DMTIMER4_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_DMTIMER9_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_DMTIMER9_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_DSI1_MPU_M3_SHIFT				5
#define OMAP4430_WKUPDEP_DSI1_MPU_M3_MASK				BITFIELD(5, 5)
...
/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_DSI1_DSP_SHIFT					6
#define OMAP4430_WKUPDEP_DSI1_DSP_MASK					BITFIELD(6, 6)

/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_DSI2_MPU_M3_SHIFT				9
#define OMAP4430_WKUPDEP_DSI2_MPU_M3_MASK				BITFIELD(9, 9)
...
/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_DSI2_DSP_SHIFT					10
#define OMAP4430_WKUPDEP_DSI2_DSP_MASK					BITFIELD(10, 10)

/* Used by PM_WKUP_GPIO1_WKDEP */
#define OMAP4430_WKUPDEP_GPIO1_IRQ1_MPU_M3_SHIFT			1
#define OMAP4430_WKUPDEP_GPIO1_IRQ1_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_WKUP_GPIO1_WKDEP */
#define OMAP4430_WKUPDEP_GPIO1_IRQ2_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_GPIO1_IRQ2_DSP_MASK				BITFIELD(6, 6)

/* Used by PM_L4PER_GPIO2_WKDEP */
#define OMAP4430_WKUPDEP_GPIO2_IRQ1_MPU_M3_SHIFT			1
#define OMAP4430_WKUPDEP_GPIO2_IRQ1_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_GPIO2_WKDEP */
#define OMAP4430_WKUPDEP_GPIO2_IRQ2_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_GPIO2_IRQ2_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_GPIO3_WKDEP */
#define OMAP4430_WKUPDEP_GPIO3_IRQ2_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_GPIO3_IRQ2_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_GPIO4_WKDEP */
#define OMAP4430_WKUPDEP_GPIO4_IRQ2_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_GPIO4_IRQ2_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_GPIO5_WKDEP */
#define OMAP4430_WKUPDEP_GPIO5_IRQ2_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_GPIO5_IRQ2_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_GPIO6_WKDEP */
#define OMAP4430_WKUPDEP_GPIO6_IRQ2_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_GPIO6_IRQ2_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_HDMIIRQ_MPU_M3_SHIFT				13
#define OMAP4430_WKUPDEP_HDMIIRQ_MPU_M3_MASK				BITFIELD(13, 13)
...
/* Used by PM_DSS_DSS_WKDEP */
#define OMAP4430_WKUPDEP_HDMIIRQ_DSP_SHIFT				14
#define OMAP4430_WKUPDEP_HDMIIRQ_DSP_MASK				BITFIELD(14, 14)
...
#define OMAP4430_WKUPDEP_HSI_DSP_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_HSI_DSP_DSP_MASK				BITFIELD(6, 6)

/* Used by PM_L3INIT_HSI_WKDEP */
#define OMAP4430_WKUPDEP_HSI_MCU_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_HSI_MCU_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_I2C1_WKDEP */
#define OMAP4430_WKUPDEP_I2C1_IRQ_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_I2C1_IRQ_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_I2C2_WKDEP */
#define OMAP4430_WKUPDEP_I2C2_IRQ_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_I2C2_IRQ_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_I2C3_WKDEP */
#define OMAP4430_WKUPDEP_I2C3_IRQ_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_I2C3_IRQ_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_I2C4_WKDEP */
#define OMAP4430_WKUPDEP_I2C4_IRQ_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_I2C4_IRQ_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_ABE_MCASP_WKDEP */
#define OMAP4430_WKUPDEP_MCASP1_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_MCASP1_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_ABE_MCASP_WKDEP */
#define OMAP4430_WKUPDEP_MCASP1_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCASP1_IRQ_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_L4PER_MCASP2_WKDEP */
#define OMAP4430_WKUPDEP_MCASP2_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_MCASP2_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_MCASP2_WKDEP */
#define OMAP4430_WKUPDEP_MCASP2_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCASP2_IRQ_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_L4PER_MCASP3_WKDEP */
#define OMAP4430_WKUPDEP_MCASP3_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_MCASP3_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_MCASP3_WKDEP */
#define OMAP4430_WKUPDEP_MCASP3_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCASP3_IRQ_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_MCBSP1_WKDEP */
#define OMAP4430_WKUPDEP_MCBSP1_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCBSP1_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_MCBSP2_WKDEP */
#define OMAP4430_WKUPDEP_MCBSP2_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCBSP2_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_MCBSP3_WKDEP */
#define OMAP4430_WKUPDEP_MCBSP3_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCBSP3_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_L4PER_MCBSP4_WKDEP */
#define OMAP4430_WKUPDEP_MCBSP4_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCBSP4_DSP_MASK				BITFIELD(2, 2)

/* Used by PM_L4PER_MCSPI1_WKDEP */
#define OMAP4430_WKUPDEP_MCSPI1_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MCSPI1_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_MCSPI1_WKDEP */
#define OMAP4430_WKUPDEP_MCSPI1_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_MCSPI1_DSP_MASK				BITFIELD(2, 2)

/* Used by PM_L4PER_MCSPI2_WKDEP */
#define OMAP4430_WKUPDEP_MCSPI2_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MCSPI2_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_MMC1_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MMC1_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L3INIT_MMC1_WKDEP */
#define OMAP4430_WKUPDEP_MMC1_DSP_SHIFT					2
#define OMAP4430_WKUPDEP_MMC1_DSP_MASK					BITFIELD(2, 2)

/* Used by PM_L3INIT_MMC2_WKDEP */
#define OMAP4430_WKUPDEP_MMC2_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MMC2_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L3INIT_MMC2_WKDEP */
#define OMAP4430_WKUPDEP_MMC2_DSP_SHIFT					2
#define OMAP4430_WKUPDEP_MMC2_DSP_MASK					BITFIELD(2, 2)

/* Used by PM_L3INIT_MMC6_WKDEP */
#define OMAP4430_WKUPDEP_MMC6_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MMC6_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L3INIT_MMC6_WKDEP */
#define OMAP4430_WKUPDEP_MMC6_DSP_SHIFT					2
#define OMAP4430_WKUPDEP_MMC6_DSP_MASK					BITFIELD(2, 2)

/* Used by PM_L4PER_MMCSD3_WKDEP */
#define OMAP4430_WKUPDEP_MMCSD3_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MMCSD3_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_MMCSD4_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MMCSD4_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_MMCSD5_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_MMCSD5_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L3INIT_PCIESS_WKDEP */
#define OMAP4430_WKUPDEP_PCIESS_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_PCIESS_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_PDM_WKDEP */
#define OMAP4430_WKUPDEP_PDM_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_PDM_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_ABE_PDM_WKDEP */
#define OMAP4430_WKUPDEP_PDM_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_PDM_IRQ_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_L3INIT_SATA_WKDEP */
#define OMAP4430_WKUPDEP_SATA_DSP_SHIFT					2
#define OMAP4430_WKUPDEP_SATA_DSP_MASK					BITFIELD(2, 2)
...
/* Used by PM_ABE_SLIMBUS_WKDEP */
#define OMAP4430_WKUPDEP_SLIMBUS1_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_SLIMBUS1_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_ABE_SLIMBUS_WKDEP */
#define OMAP4430_WKUPDEP_SLIMBUS1_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_SLIMBUS1_IRQ_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_L4PER_SLIMBUS2_WKDEP */
#define OMAP4430_WKUPDEP_SLIMBUS2_DMA_DSP_SHIFT				6
#define OMAP4430_WKUPDEP_SLIMBUS2_DMA_DSP_MASK				BITFIELD(6, 6)
...
/* Used by PM_L4PER_SLIMBUS2_WKDEP */
#define OMAP4430_WKUPDEP_SLIMBUS2_IRQ_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_SLIMBUS2_IRQ_DSP_MASK				BITFIELD(2, 2)

/* Used by PM_ALWON_SR_CORE_WKDEP */
#define OMAP4430_WKUPDEP_SR_CORE_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_SR_CORE_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_SR_IVA_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_SR_IVA_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_ABE_TIMER5_WKDEP */
#define OMAP4430_WKUPDEP_TIMER5_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_TIMER5_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_TIMER6_WKDEP */
#define OMAP4430_WKUPDEP_TIMER6_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_TIMER6_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_TIMER7_WKDEP */
#define OMAP4430_WKUPDEP_TIMER7_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_TIMER7_DSP_MASK				BITFIELD(2, 2)
...
/* Used by PM_ABE_TIMER8_WKDEP */
#define OMAP4430_WKUPDEP_TIMER8_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_TIMER8_DSP_MASK				BITFIELD(2, 2)
...
#define OMAP4430_WKUPDEP_UART3_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_UART3_MPU_M3_MASK				BITFIELD(1, 1)
...
/* Used by PM_L4PER_UART3_WKDEP */
#define OMAP4430_WKUPDEP_UART3_DSP_SHIFT				2
#define OMAP4430_WKUPDEP_UART3_DSP_MASK					BITFIELD(2, 2)
...
#define OMAP4430_WKUPDEP_UNIPRO1_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_UNIPRO1_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_USB_HOST_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_USB_HOST_MPU_M3_MASK				BITFIELD(1, 1)

/* Used by PM_L3INIT_USB_HOST_FS_WKDEP */
#define OMAP4430_WKUPDEP_USB_HOST_FS_MPU_M3_SHIFT			1
#define OMAP4430_WKUPDEP_USB_HOST_FS_MPU_M3_MASK			BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_USB_OTG_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_USB_OTG_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_USB_TLL_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_USB_TLL_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_WDT2_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_WDT2_MPU_M3_MASK				BITFIELD(1, 1)
...
#define OMAP4430_WKUPDEP_XHPI_MPU_M3_SHIFT				1
#define OMAP4430_WKUPDEP_XHPI_MPU_M3_MASK				BITFIELD(1, 1)
